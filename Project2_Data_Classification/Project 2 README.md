...
The project uses the classic **Iris Dataset** and a **K-Nearest Neighbors (KNN)** classifier to predict an iris flower's species based on its physical measurements.
